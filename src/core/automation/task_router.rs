...
use crate::core::model::prompt_policy::delegated_policy_v2_block;
use crate::core::orchestration::orchestra::SubAgentType;
use crate::core::orchestration::planner::{PlanStepStatus, PlanSubstep};
use crate::core::queue_stream_event;
use crate::core::runtime::config::{ModelRole, ModelSlot};
use crate::core::swarm::agent_trait::SwarmAgent;
use crate::core::swarm::specialist::SpecialistAgent;
use crate::core::swarm::{AgentAccessScope, SwarmActivityAgent, SwarmActivityTracker};
use crate::core::PromptMemory;
use crate::core::{DegradationNote, DelegationStatus, FailureKind, StreamEvent};
...
fn execution_plan_step_status(
    step: &crate::core::orchestration::planner::PlanStep,
) -> PlanStepStatus {
    step.status.unwrap_or(PlanStepStatus::Pending)
}

fn sync_execution_plan_trace_step(trace: &mut crate::core::agent::ExecutionTrace) {
...
fn execution_plan_step_snapshot(
    trace: &crate::core::agent::ExecutionTrace,
    step_id: usize,
) -> Option<(
    String,
    u32,
...
async fn update_delegated_plan_step_status(
    trace_ref: &Arc<RwLock<crate::core::agent::ExecutionTrace>>,
    token_tx: Option<&tokio::sync::mpsc::Sender<StreamEvent>>,
    step_id: usize,
    status: PlanStepStatus,
    detail: Option<String>,
...
) -> crate::core::model::llm::LlmResponse {
...
pub struct DelegatedResult {
    ...
    pub final_response: crate::core::model::llm::LlmResponse,
...
pub struct AgentExecResult {
    ...
    pub llm_response: Option<crate::core::model::llm::LlmResponse>,
...
type SpecialistRegistry = Arc<RwLock<HashMap<crate::core::swarm::AgentId, Arc<SpecialistAgent>>>>;
...
pub struct TaskRouterExecuteContext<'a> {
    ...
    pub trace: &'a Arc<RwLock<crate::core::agent::ExecutionTrace>>,
...
impl TaskRouter {
        ...
        for (index, spec) in decision.sub_agents.iter().enumerate() {
            ...
            if let Some((name, specialist)) = specialist_match {
                ...
                // Trace: specialist matched
                {
                    ...
                    t.steps.push(crate::core::agent::ExecutionStep {
    ...
    async fn find_matching_specialist(
        &self,
        specialists: &Arc<RwLock<HashMap<crate::core::swarm::AgentId, Arc<SpecialistAgent>>>>,
        task: &str,
    ...
    async fn execute_assignments(
        ...
        actions: &[ActionDef],
        action_scope_hints: &HashMap<String, crate::runtime::ActionScopeHint>,
        trace: &Arc<RwLock<crate::core::agent::ExecutionTrace>>,
        token_tx: Option<&tokio::sync::mpsc::Sender<StreamEvent>>,
    ...
    async fn aggregate(
        ...
        memories: &[PromptMemory],
        _actions: &[ActionDef],
    ) -> Result<crate::core::model::llm::LlmResponse> {
