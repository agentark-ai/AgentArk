...
impl SubAgentType {
    ...
    pub fn system_prompt(&self) -> String {
        match self {
            Self::Researcher => {
                crate::core::model::prompt_policy::specialist_researcher_system_prompt_v1()
            }
            Self::Coder => crate::core::model::prompt_policy::specialist_coder_system_prompt_v1(),
            Self::Analyst => {
                crate::core::model::prompt_policy::specialist_analyst_system_prompt_v1()
            }
            Self::Writer => crate::core::model::prompt_policy::specialist_writer_system_prompt_v1(),
            Self::Validator => {
                crate::core::model::prompt_policy::specialist_validator_system_prompt_v1()
            }
            Self::Planner => {
                crate::core::model::prompt_policy::specialist_planner_system_prompt_v1()
            }
