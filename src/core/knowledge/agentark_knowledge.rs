...
fn build_connect_flow_docs() -> Vec<SeedKnowledgeItem> {
    ...
    for spec in crate::core::connectivity::connect_flow::all_specs() {
...
- System-owned | {}\n\
- Rule | {}",
        crate::core::runtime::data_contract::USER_OWNED_SURFACES.join(", "),
        crate::core::runtime::data_contract::SYSTEM_OWNED_SURFACES.join(", "),
        crate::core::runtime::data_contract::RELEASE_UPDATE_RULE,
    );
    items.push(SeedKnowledgeItem {
