...
fn build_gateway_channels_summary(
    summary: &crate::core::gateway::GatewayChannelsSummary,
...
fn build_gateway_routing_summary(
    summary: &crate::core::gateway::GatewayRoutingSummary,
) -> GatewayOpsServiceSummary {
...
fn build_nodes_summary(summary: &crate::core::nodes::NodeSummary) -> GatewayOpsServiceSummary {
...
fn build_browser_summary(
    summary: &crate::core::browser_profiles::BrowserProfileSummary,
) -> GatewayOpsServiceSummary {
    let status = if summary.total == 0 {
        "unknown"
...
fn build_model_failover_summary(
    summary: &crate::core::model_failover::ModelFailoverSummary,
) -> GatewayOpsServiceSummary {
...
fn build_nodes_check(summary: &crate::core::nodes::NodeSummary) -> GatewayOpsOperatorCheck {
