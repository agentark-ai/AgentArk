...
impl super::Agent {
    ...
    pub(super) fn conversation_history_budget(
        ...
        let history_tokens =
            crate::core::context_budget::read_usize_env("AGENTARK_CHAT_HISTORY_TOKEN_BUDGET")
                .unwrap_or_else(|| {
    ...
    pub(super) fn conversation_message_token_estimate(
        ...
        crate::core::context_budget::estimate_role_message_tokens(
            &message.role,
            &crate::core::context_budget::truncate_to_token_budget(&message.content, max_tokens),
        )
    }
