...
fn default_required_fields() -> Vec<String> {
    [
        ...
        "reason",
        "error",
        // Credential-handoff and repair-routing keys: dropping these under a
        // tightened distill profile would silently strip the secure-credential
        // prompt or the spine's recoverability signals from tool envelopes.
        "credential_request",
        "settings_path",
