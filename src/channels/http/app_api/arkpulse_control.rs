...
pub(super) struct PulseCleanupJobSnapshot {
    ...
    skipped_count: usize,
    #[serde(default)]
    archived: Vec<crate::core::platform::artifact_hygiene::ArchivedArtifactOutcome>,
    #[serde(default)]
    errors: Vec<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    retention: Option<crate::core::platform::artifact_hygiene::ArchiveRetentionSummary>,
}
...
async fn collect_arkpulse_cleanup_candidates_for_state(
    state: &AppState,
) -> Result<Vec<crate::core::platform::artifact_hygiene::ArtifactCleanupCandidate>> {
    ...
    let idle_apps = state
        ...
        .collect::<HashMap<_, _>>();
    crate::core::platform::artifact_hygiene::collect_artifact_cleanup_candidates(
...
pub(super) async fn run_arkpulse_readonly_investigation_fix(
    ...
    match topic {
        crate::sentinel::DoctorReadonlyInvestigationTopic::MemoryCaptureHealth => {
            ...
            let model_failover =
                match crate::core::model::model_failover::ModelFailoverControlPlane::list(&storage)
                    .await
                {
                    Ok(value) => value,
                    Err(error) => {
...
pub(super) async fn arkpulse_cleanup_preview(
    ...
    Json(serde_json::json!({
        ...
        "archive_retention_days": crate::core::platform::artifact_hygiene::ARCHIVE_RETENTION_DAYS,
...
async fn run_arkpulse_cleanup_worker(
    ...
    Vec<crate::core::platform::artifact_hygiene::ArchivedArtifactOutcome>,
    usize,
    Vec<String>,
    ...
    for candidate in selected {
        ...
        match crate::core::platform::artifact_hygiene::archive_cleanup_candidate(
            &data_dir,
            &candidate,
    ...
    let retention =
        crate::core::platform::artifact_hygiene::prune_archive_retention(&data_dir).await?;
    Ok((archived, skipped_count, errors, retention))
}
