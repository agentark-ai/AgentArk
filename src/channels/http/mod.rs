...
#[path = "action_api/actions.rs"]
pub(crate) mod actions;
#[path = "analytics_api/analytics_control.rs"]
mod analytics_control;
#[path = "core_api/api_docs_control.rs"]
mod api_docs_control;
#[path = "core_api/api_types.rs"]
mod api_types;
#[path = "app_api/app_serving.rs"]
mod app_serving;
#[path = "app_api/applications.rs"]
mod applications;
#[path = "analytics_api/arkdistill_analytics.rs"]
mod arkdistill_analytics;
#[path = "app_api/arkorbit_control.rs"]
mod arkorbit_control;
#[path = "app_api/arkpulse_control.rs"]
mod arkpulse_control;
#[path = "core_api/auth.rs"]
mod auth;
#[path = "admin_api/auth_profiles_control.rs"]
mod auth_profiles_control;
#[path = "automation_api/automation_control.rs"]
mod automation_control;
#[path = "automation_api/autonomy_control.rs"]
mod autonomy_control;
#[path = "automation_api/autonomy_support.rs"]
mod autonomy_support;
#[path = "runtime_api/browser_profiles_control.rs"]
mod browser_profiles_control;
#[path = "core_api/chat_control.rs"]
mod chat_control;
#[path = "app_api/companion_control.rs"]
mod companion_control;
#[path = "core_api/control_commands.rs"]
mod control_commands;
#[path = "core_api/conversation_control.rs"]
mod conversation_control;
#[path = "action_api/custom_apis.rs"]
mod custom_apis;
#[path = "integration_api/custom_messaging_channels.rs"]
mod custom_messaging_channels;
#[path = "runtime_api/document_control.rs"]
mod document_control;
#[path = "automation_api/evolution_control.rs"]
mod evolution_control;
#[path = "action_api/extension_packs.rs"]
mod extension_packs;
#[path = "integration_api/gateway_control.rs"]
mod gateway_control;
#[path = "integration_api/gateway_ops_control.rs"]
mod gateway_ops_control;
#[path = "action_api/hooks_control.rs"]
mod hooks_control;
#[path = "integration_api/integration_sync.rs"]
mod integration_sync;
#[path = "integration_api/integrations.rs"]
mod integrations;
#[path = "admin_api/locked_control.rs"]
mod locked_control;
#[path = "action_api/mcp_control.rs"]
mod mcp_control;
#[path = "runtime_api/memory_control.rs"]
mod memory_control;
#[path = "core_api/middleware_control.rs"]
mod middleware_control;
#[path = "runtime_api/model_failover_control.rs"]
mod model_failover_control;
#[path = "action_api/nodes_control.rs"]
mod nodes_control;
#[path = "core_api/notification_control.rs"]
mod notification_control;
#[path = "analytics_api/observability.rs"]
mod observability;
#[path = "action_api/plugins.rs"]
mod plugins;
#[path = "admin_api/profile_control.rs"]
mod profile_control;
#[path = "automation_api/reflect_control.rs"]
mod reflect_control;
#[path = "runtime_api/runtime_control.rs"]
mod runtime_control;
#[path = "admin_api/secrets_control.rs"]
mod secrets_control;
#[path = "admin_api/security_control.rs"]
mod security_control;
#[path = "admin_api/sender_verification.rs"]
mod sender_verification;
#[path = "automation_api/sentinel_panel.rs"]
mod sentinel_panel;
#[path = "core_api/server_utils.rs"]
mod server_utils;
#[path = "runtime_api/settings_control.rs"]
mod settings_control;
#[path = "action_api/skill_marketplaces.rs"]
mod skill_marketplaces;
#[path = "app_api/suggestions.rs"]
mod suggestions;
#[path = "automation_api/swarm_control.rs"]
mod swarm_control;
#[cfg(test)]
#[path = "core_api/tests.rs"]
mod tests;
#[path = "analytics_api/trace.rs"]
mod trace;
#[path = "tunnel_api/tunnel.rs"]
mod tunnel;
#[path = "tunnel_api/tunnel_auth.rs"]
mod tunnel_auth;
#[path = "app_api/ui_control.rs"]
mod ui_control;
#[path = "runtime_api/voice_control.rs"]
mod voice_control;
#[path = "integration_api/webhooks.rs"]
...
use crate::core::runtime::data_lifecycle::{
...
async fn load_saved_model_slot_api_key(
    ...
    match tokio::task::spawn_blocking(move || -> Result<Option<String>> {
        let secure = crate::core::runtime::config::SecureConfigManager::new_with_data_dir(
            &config_dir,
...
fn shared_http_client() -> &'static reqwest::Client {
    ...
    CLIENT.get_or_init(crate::core::runtime::net::default_outgoing_http_client)
}
...
pub struct ChatRequest {
    ...
    /// Browser-supplied IANA timezone for request-scoped wall-clock scheduling.
    /// Saved profile timezone remains authoritative when present.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
fn parse_set_secret_command(message: &str) -> Option<(String, String)> {
    crate::core::runtime::secrets::parse_set_secret_command(message)
}
...
pub async fn serve(
    ...
    let state = {
        ...
        let api_key_info = crate::core::runtime::config::SecureConfigManager::new_with_data_dir(
    ...
    let protected_routes = Router::new()
        ...
        .route(
            "/api/apps/{app_id}/env",
            get(get_app_env).put(update_app_env),
        )
        .route(
