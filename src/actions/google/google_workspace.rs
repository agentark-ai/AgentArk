...
fn manager(config_dir: &Path) -> Result<crate::core::runtime::config::SecureConfigManager> {
...
"#;
    ...
    fn granted_bundle_visibility_rejects_ungranted_services() {
        ...
        let manager = crate::core::runtime::config::SecureConfigManager::new(dir.path()).unwrap();
        manager
            .set_custom_secret(
                GOOGLE_WORKSPACE_TOKENS_KEY,
                Some(
